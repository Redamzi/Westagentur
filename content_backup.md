...
- Professional: 3.200€
- Ultimate 3D: 5.000€+
(Features backed up in previous context)

## Main Page Content
- **Hero:**
  - HUD Labels: REAKTIONSZEIT (24 STUNDEN), SICHERHEIT (DSGVO), QUALITÄT (PREMIUM)
  - Title: STRATEGIE & DESIGN DIGITALE MARKTFÜHRER.
  - Subtitle: Wir transformieren Marken in digitale Anlaufstellen. Modernes Webdesign für den deutschen Mittelstand.
  - Buttons: Projekt anfragen, Leistungen ansehen

- **Services:**
  - Cards: STRATEGIE / Modernes Webdesign, REICHWEITE / SEO-Optimierung, EFFIZIENZ / Automatisierung, IMMERSION / 3D Erlebnisse, INTELLIGENZ / KI-Lösungen, SECURITY / Cyber Security

## About Section
- Title: Über Westagentur / Unsere Vision
- Text: Wir sind nicht nur eine Agentur – wir sind Ihr digitaler Architekt. In einer Welt, die sich immer schneller dreht, braucht der Mittelstand Partner...
- Stats: 100% Leidenschaft, 24/7 Innovation, KMU Fokus
