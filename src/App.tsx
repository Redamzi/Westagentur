                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10">
                        ...
                        {[
                            ...
                            <div
                                ...
                                className={`group p-8 md:p-10 cosmic-glass glass-reflection rounded-[2rem] md:rounded-[2.5rem] border-white/5 relative overflow-hidden cursor-pointer animate-float ${isVisible ? 'animate-entrance' : ''}`}
                            >
                        ...
                        {[
                            ...
                            <div
                                ...
                                className={`group p-8 md:p-10 cosmic-glass glass-reflection rounded-[2rem] md:rounded-[2.5rem] border-cyan-500/20 relative overflow-hidden flex flex-col cursor-pointer animate-float ${isVisible ? 'animate-entrance' : ''}`}
                            >
